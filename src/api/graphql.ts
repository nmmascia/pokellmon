...
// The typed `graphql()` document builder for the PokéAPI (v1beta2) schema.
//
...
//   pnpm exec gql.tada generate-schema https://graphql.pokeapi.co/v1beta2 --output src/api/schema.graphql
